...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1100425541133283368/1212428029100556358/1b23b143.png?ex=65f1cc97&is=65df5797&hm=6bcd3a99201c66cd8fb374f02f71f98255e18a34960c78634263c8e83092d2e7&']; //รูปใหญ่
    ...
    const ddds = ['https://www.facebook.com/share/x9PYyKzXoUoKDLaA/?mibextid=dGKdO6']; // ลิ้ง button1

   const iooi = ['Instagram']; // ชื่อ button 2
   const iiio = ['https://www.instagram.com/m3ikx_']; // ลิ้ง button 2
...
change[Math.floor(Math.random()*change.length)]; // รูปใหญ่
    ...
    const r = new Discord.RichPresence()
      ...
      .setName(`RobShop`)
      .setDetails(`IG : m3ikx_`)
      //.setAssetsSmallImage(`${popp}`) 
.setAssetsLargeImage(`${ssss}`)
.setAssetsLargeText(`.setAssetsLargeText(`꒰ ${getTime()} ꒱ ${moment().format('• ꒰ DD/MM/YYYY ꒱')}`)
